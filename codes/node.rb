...
SETTINGS = {
  :url          => "https://foreman.rhel6.site",  # e.g. https://foreman.example.com
  ...
  :ssl_ca       => "/etc/puppet/ssl/certs/ca.pem",      # e.g. /var/lib/puppet/ssl/certs/ca.pem
  # ssl_cert and key are required if require_ssl_puppetmasters is enabled in Foreman
  :ssl_cert     => "/etc/puppet/ssl/certs/puppetca.rhel6.site.pem",    # e.g. /var/lib/puppet/ssl/certs/FQDN.pem
  :ssl_key      => "/etc/puppet/ssl/private_keys/puppetca.rhel6.site.pem"      # e.g. /var/lib/puppet/ssl/private_keys/FQDN.pem
}
